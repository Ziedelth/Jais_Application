...
void main() {
  ...
  group('Test episodes', () {
    ...
    test('Test loading episodes', () {
      ...
      expect(episodeMapper.list.whereType<EpisodeLoaderWidget>().length, episodeMapper.limit);
